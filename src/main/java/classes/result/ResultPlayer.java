...
public class ResultPlayer implements Serializable
{
    ...
    public String toString() {
        ...
        sb.append(ResultPlayer.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ResultPlayer) == false) {
            return false;
        }
        ResultPlayer rhs = ((ResultPlayer) other);
